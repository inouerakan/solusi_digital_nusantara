...
export default function ServicesForm({data, fetchServices, isCreateData}) {
    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            if (selectedFile) {
                ...
                const uploadRes = await axiosInstance.post('/upload/services', formData, {
            ...
            if (isCreateData) {
                ...
                await axiosInstance.put(`/services/${data.id}`, {
                    name,
                    description,
                    content,
                    image_url: finalImageUrl
    ...
    const handleDelete = async () => {
        ...
        setIsLoading(true);
        try {
            await axiosInstance.delete(`/services/${data.id}`);
            fetchServices();
        } catch (err) {
